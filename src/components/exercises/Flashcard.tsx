  ...
  return (
    <Card>
      ...
      <button
        ...
        disabled={revealed}
        className="flex min-h-[10rem] w-full flex-col items-center justify-center rounded-2xl border-2 border-forest-200 bg-forest-50 px-4 py-8 text-center active:opacity-75 [touch-action:manipulation]"
      >
        <span className="text-2xl font-semibold text-forest-700">{front}</span>
