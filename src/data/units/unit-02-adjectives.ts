  ...
  lessons: [
    {
      ...
      exampleSentences: [
        {
          ...
          dutch: "Mahes heeft een huisje gekocht.",
          vocabRefs: ["adj-chota"],
        },
        {
          id: "ex-6-2",
          sarnami: "Mahes chŏṭkā gharvā kīnis hai.",
          dutch: "Mahes heeft het huisje gekocht.",
          vocabRefs: ["adj-chota"],
        },
        {
          id: "ex-6-3",
          sarnami: "Hariyā lāl somth pahine hai.",
          dutch: "Hari draagt een rood overhemd.",
          vocabRefs: ["adj-lal"],
        },
      ],
      grammarNotes: [
      ...
      exercises: [
        ...
        },
        {
          ...
          dutchTranslation: "Mahes heeft een huisje gekocht.",
        },
        {
          id: "l6-e4",
          kind: "flashcard",
        ...
        },
        {
          id: "l6-e5",
          kind: "word-bank",
          promptDutch: "Mahes heeft het huisje gekocht.",
    ...
    },
    {
      ...
      exampleSentences: [
        {
          ...
          dutch: "Een grote boom.",
          vocabRefs: ["adj-barka"],
        },
        {
          id: "ex-7-2",
          sarnami: "Ū barkāvan pervan.",
          dutch: "Die grote bomen.",
          vocabRefs: ["adj-barka"],
        },
        {
          id: "ex-7-3",
          sarnami: "Karikkanī bakariyā.",
          dutch: "De zwarte geit.",
      ...
      exercises: [
        ...
        },
        {
          ...
          dutchTranslation: "De zwarte geit.",
        },
        {
          id: "l7-e5",
          kind: "flashcard",
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          dutchTranslation: "Mijn huis is groter dan jouw huis.",
        },
        {
          id: "l8-e3",
          kind: "word-bank",
          promptDutch: "In Suriname is hij de rijkste man.",
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          id: "l9-e3",
          kind: "word-bank",
          promptDutch: "Mijn huis is groter dan jouw huis.",
